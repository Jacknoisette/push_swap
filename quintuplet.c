...
/*   Updated: 2024/12/16 12:27:40 by jdhallen         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
// int revquintuplet(t_stack *stack_a, t_stack *stack_b, int len, int count)
// {
// 	int dif;

// 	dif = len - stack_a->len;
// 	if (check_revsort(stack_a, len, dif))
// 		return (count);
// 	while (stack_a->len > 3)
// 	{
// 		if ((check_seclittle(stack_a, len, dif) == dif && stack_a->len > 4)
// 			|| check_big(stack_a, len, dif) == dif)
// 		{
// 			count += push(stack_b, stack_a, len);
// 			dif += 1;
// 		}
...
// 	count += push(stack_a, stack_b, len);
// 	dif -= 1;
// 	if (check_big(stack_a, len, dif) != dif)
// 		swap(stack_a, len, 1);
// 	return (count);
// }
